    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="{{ route('dashboard') }}">
                ...
                <p style="font-weight: 900; font-size: 20px">Meta Market</p>
            </a>
            <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}">
                {{-- <img src="{{ asset('public/assets/images/logo-mini.svg') }}" alt="logo" /> --}}
                <p style="font-weight: 900; font-size: 20px; ">MM</p>
            </a>
        </div>
    </div>
            ...
            <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                ...
                @elseif ($hour < 17)
                    <h1 class="welcome-text">Good Afternoon, <span
                            class="text-black fw-bold">{{ auth()->user()->name }}!</span></h1>
                @else
                    <h1 class="welcome-text"> Good Evening!, <span
                            class="text-black fw-bold">{{ auth()->user()->name }}!</span></h1>
                @endif
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0"
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="{{ asset('public/assets/images/faces/face10.jpg') }}" alt="image"
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-thumbnail">
                            <img src="{{ asset('public/assets/images/faces/face12.jpg') }}" alt="image"
                                class="img-sm profile-pic">
                        </div>
                        <div class="preview-item-content flex-grow py-2">
